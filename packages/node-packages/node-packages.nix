...
in
{
  "@jakehamilton/titan" = nodeEnv.buildNodePackage {
    ...
    version = "5.11.2";
    src = fetchurl {
      url = "https://registry.npmjs.org/@jakehamilton/titan/-/titan-5.11.2.tgz";
      sha512 = "x53qpDLWj74DXDXIH9NEiGFddeWq1mwBeMe0YkLygfuzTiHWbPwXA52pQcoI2k6eFGSem0SV5fOSvVMNKmh78g==";
    };
    dependencies = [
