...
let
  sources = {
    ...
    "@littlethings/log-3.0.6" = {
      ...
      version = "3.0.6";
      src = fetchurl {
        url = "https://registry.npmjs.org/@littlethings/log/-/log-3.0.6.tgz";
        sha512 = "6ZvjunC2y5mNlfbBHcpuk/uz+EvsRU+6FhQeMlBgA/3isuISsHJyjPITn6rMZGk7h9O+jjzKO1YiYPq98gBJtQ==";
      };
    };
...
in
{
  "@jakehamilton/titan" = nodeEnv.buildNodePackage {
    ...
    dependencies = [
      sources."@littlethings/log-3.0.6"
      (sources."@littlethings/test-1.2.1" // { dependencies = [ sources."@littlethings/log-1.4.0" ]; })
      (sources."@starters/core-1.8.0" // { dependencies = [ sources."kleur-4.1.5" ]; })
